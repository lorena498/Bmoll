...
import type { Product, Video, Track, Link } from './types';
...
export const videos: Video[] = [
  { id: 1, title: 'Nuevo Sencillo Oficial', description: 'El video oficial de nuestro más reciente lanzamiento.', thumbnailUrl: 'https://i.ytimg.com/vi/X7HmWrbk8bo/hqdefault.jpg', videoUrl: 'https://www.youtube.com/watch?v=X7HmWrbk8bo' },
  { id: 2, title: 'Live Session Acústica', description: 'Una versión íntima de nuestras canciones favoritas.', thumbnailUrl: 'https://i.ytimg.com/vi/b_0pX-MLNx4/hqdefault.jpg', videoUrl: 'https://www.youtube.com/watch?v=b_0pX-MLNx4' },
  { id: 3, title: 'Si Me Llamas', description: 'Video Oficial.', thumbnailUrl: 'https://i.ytimg.com/vi/LncQmAuL2F4/hqdefault.jpg', videoUrl: 'https://www.youtube.com/watch?v=LncQmAuL2F4' },
  { id: 4, title: 'X (EQUIS) - Nicky Jam x J Balvin', description: 'Video Oficial.', thumbnailUrl: 'https://i.ytimg.com/vi/H5DoyCvhuHk/hqdefault.jpg', videoUrl: 'https://www.youtube.com/watch?v=H5DoyCvhuHk' },
  { id: 5, title: 'DÁKITI - BAD BUNNY x JHAY CORTEZ', description: 'Video Oficial.', thumbnailUrl: 'https://i.ytimg.com/vi/T2urNjF5g4A/hqdefault.jpg', videoUrl: 'https://www.youtube.com/watch?v=T2urNjF5g4A' },
  { id: 6, title: 'Mora, Feid - LA INOCENTE', description: 'Video Oficial.', thumbnailUrl: 'https://i.ytimg.com/vi/bWODU2wARKE/hqdefault.jpg', videoUrl: 'https://www.youtube.com/watch?v=bWODU2wARKE' },
  { id: 7, title: 'KAROL G - PROVENZA', description: 'Video Oficial.', thumbnailUrl: 'https://i.ytimg.com/vi/b0Gvnfy4NwA/hqdefault.jpg', videoUrl: 'https://www.youtube.com/watch?v=b0Gvnfy4NwA' },
  { id: 8, title: 'Myke Towers - LALA', description: 'Video Oficial.', thumbnailUrl: 'https://i.ytimg.com/vi/sDHWUOwZTjY/hqdefault.jpg', videoUrl: 'https://www.youtube.com/watch?v=sDHWUOwZTjY' },
  { id: 9, title: 'Rauw Alejandro - SANTA', description: 'Video Oficial.', thumbnailUrl: 'https://i.ytimg.com/vi/LAY1Awj2vEI/hqdefault.jpg', videoUrl: 'https://www.youtube.com/watch?v=LAY1Awj2vEI' },
  { id: 10, title: 'ROSALÍA - BIZCOCHITO', description: 'Video Oficial.', thumbnailUrl: 'https://i.ytimg.com/vi/MExFDp0pmGc/hqdefault.jpg', videoUrl: 'https://www.youtube.com/watch?v=MExFDp0pmGc' },
  { id: 11, title: 'Quevedo || BZRP Music Sessions #52', description: 'Video Oficial.', thumbnailUrl: 'https://i.ytimg.com/vi/7hAyeIjtBNk/hqdefault.jpg', videoUrl: 'https://www.youtube.com/watch?v=7hAyeIjtBNk' }
];
